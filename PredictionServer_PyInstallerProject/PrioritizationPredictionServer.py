"""
PrioritizationPredictionServer.py
--------------------------------
    Server used solely to predict the priority level of a Guardian target.

    Executable: PrioritizationPredictionServer.exe
"""
...
class PrioritizationPredictionServer:
    def __init__(self):
        ...
        self.__routing_key_prediction_server = 'prioritizationpredictionserver.cmd.primary'
        self.__routing_key_requestor = 'aimlprioritization.cmd.primary'
    ...
    def startServer(self):
        if self.__communication_type == COMMS_TYPE.UDP:
            ...
            print("Prioritization Prediction Server Online and Listening")
            while True:
...
def startSystem(config):
    prediction_server = PrioritizationPredictionServer()
